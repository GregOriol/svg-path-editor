...
export class AppComponent implements AfterViewInit {
  ...
  private readonly kAppPathScales: Record<string, number[]> = {
    'M': [1/1024, 1/768], 'L': [1/1024, 1/768], 'T': [1/1024, 1/768],
    'H': [1/1024],
    'V': [1/768],
    'C': [1/1024, 1/768, 1/1024, 1/768, 1/1024, 1/768],
    'S': [1/1024, 1/768, 1/1024, 1/768],
    'Q': [1/1024, 1/768, 1/1024, 1/768],
    'A': [1/1024, 1/768, 1, 1, 1, 1/1024, 1/768],
    'Z': [],
  };
